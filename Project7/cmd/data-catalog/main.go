...
func main() {
	...
	{
		api.GET("", catalogHandler.List)
		api.GET("/:id", catalogHandler.Get)
		api.POST("", middleware.AdminRequired(), catalogHandler.Create)
		api.PUT("/:id", middleware.AdminRequired(), catalogHandler.Update)
		api.DELETE("/:id", middleware.AdminRequired(), catalogHandler.Delete)
	}
	...
	log.Printf("Data Catalog Service starting on port %d...", servicePort)
